...
def custom_draw_geometry_with_camera_trajectory(pcd, render_option_path,
    ...
    print(custom_draw_geometry_with_camera_trajectory.trajectory.parameters)
    print("______________")
    ...
    def move_forward(vis):
        ...
        if glb.index >= 0:
            ...
            plt.imsave(os.path.join(image_path, '{:05d}.png'.format(glb.index)),
                       np.asarray(image),
                       dpi=1)
            # print the image_path
            print("image_path: ", os.path.join(image_path, '{:05d}.png'.format(glb.index)))
