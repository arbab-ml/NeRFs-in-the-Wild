# nerfstudio10) [arbab@nova22-gpu-4 NeRFs-in-the-Wild]$ python process_nerfstudio_to_sdfstudio.py --data data/nerfstudio/CCL-scanned-data-single/CCL-scannned-data-single-img-50-qual-90-processed --output-dir data/nerfstudio/CCL-scanned-data-single/CCL-scannned-data-single-img-50-qual-90-processed-sdfstudio --data-type colmap --scene-type unbound
